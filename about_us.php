...
<section class="first_section_about">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                <img src="img/about_image111-01.png">
            </div>
        </div>
        <hr>
    </div>
  ...
  <!-- Text Inside Slider -->
    <div class="logo-slider-over col-md-12 container mobile-d-n">
        <h1 class="wow fadeIn" data-wow-duration="1s" data-wow-delay=".2s">About Us</h1>
        <p class="wow fadeIn" data-wow-duration="1s" data-wow-delay=".3s">It’s all about the people</p>
        ...
        <h1>Our Management</h1>
                ...
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/Miljan-01.jpg">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/Alma 1-01.JPG">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
                            <h5>Alma Macaraig</h5>
            ...
            <div class="col-md-6 col-xs-12">
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/Ivan-01.jpg">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
                            <h5>Ivan Jankovic</h5>
             ...
             <div class="col-md-6 col-xs-12">
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/andrea_img1-01.jpg">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
                            <h5>Andre Mulder</h5>
            ...
            <div class="col-md-6 col-xs-12">
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/Manuj Misra-01.jpg">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
                            <h5>Manuj Mishra</h5>
                            <p>Senior Project Manage</p>
                            <a data-toggle="tooltip" data-placement="bottom" title="Direct Email" href="mailto:manuj.mishra@emirateslandscape.com" style="text-decoration: none !important; color: black;"><p><span>E:</span> manuj.mishra@emirateslandscape.com</p></a>            
            ...
            <div class="col-md-6 col-xs-12">
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/Paul-01.JPG">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
                            <h5>Paul Davis</h5>
            ...
            <div class="col-md-6 col-xs-12">
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/Sabeel Kareem-01.JPG">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
                            <h5>Sabeel Kareem</h5>
                            <p>QHSE Manager</p>
            ...
            <div class="col-md-6 col-xs-12">
                <div class="managment_panel_main">
                    <div class="managment_panel row">
                        <div class="col-md-3 col-xs-4 no_padding wow zoomIn" data-wow-duration="1s" data-wow-delay=".2s">
                            <img src="img/managment/Mamoun-01.jpg">
                        </div>
                        <div class="col-md-9 col-xs-8 managment_panel_text wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
